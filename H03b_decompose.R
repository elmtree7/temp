...
x = fredr_series_observations("RETAILSMSA")$value       # https://fred.stlouisfed.org/series/RETAILSMSA
x1 = fredr_series_observations("RETAILSMNSA")$value     # https://fred.stlouisfed.org/series/RETAILSMNSA

retail = ts(x,frequency=12,start=c(1992,1))    # Seasonally adjusted data
retailn = ts(x1,frequency=12,start=c(1992,1))  # Non-seasonally adjusted data
...
ts.plot(retail, retail.sa1, col=c("lightblue","green"))
